...
const VirtualCard = (): JSX.Element => {
    return (
        <section className="grid scroll-mt-14 lg:scroll-mt-[4.5rem] md:grid-cols-2" id="virtual-card">
            <Image className="order-last lg:order-first md:h-full lg:h-[32.9375rem]" src={VirtualCardImage} alt="Swift Payments with Virtual Cards" fetchPriority="high" quality={100} placeholder="blur" />
