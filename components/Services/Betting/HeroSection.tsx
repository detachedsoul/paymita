...
const HeroSection = (): JSX.Element => {
    return (
        <div className="grid items-center bg-brand-dark-purple scroll-mt-14 lg:scroll-mt-[4.5rem] lg:grid-cols-2" id="about">
            <div className="py-8 px-4 grid gap-4 md:w-4/5 md:mx-auto md:py-16 md:text-center lg:text-left lg:w-full lg:pl-20 lg:py-0 lg:pr-0">
                ...
                <h1 className="text-[2.5rem] text-white font-bold leading-[110%] lg:text-[3.5rem]">
                    Fund Your Betting Account with Paymita
                </h1>

                <p className="text-wrap text-white">
                    Elevate your online betting journey with Paymita’s easy-to-use platform. We make it simple for you to fund your betting account securely and  enjoy a seamless betting experience.
                </p>
